...
export const metadata = { title: 'Testing 2 | Premium Web' };
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        {/* Secure Context Shim (MUST BE FIRST) */}
        <script dangerouslySetInnerHTML={{ __html: `if (window.location.protocol === 'http:' && window.location.hostname !== 'localhost') {
      const mockSubtle = {
      ...
      console.log('Studio Infra: Shim v3 Active (Top-of-Head Execution)');
        ...
        <link href="https://fonts.googleapis.com/css2?family=Mazzard+H:wght@400;700;900&family=Syne:wght@400;500;700&display=swap" rel="stylesheet" />
      </head>
